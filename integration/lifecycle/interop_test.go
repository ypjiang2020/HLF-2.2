		...
		Describe("Chaincode-to-chaincode interoperability", func() {
			...
			BeforeEach(func() {
				...
				callerDefOld = nwo.Chaincode{
					Name:    "caller",
					Version: "0.0",
					Path:    "github.com/Yunpeng-J/HLF-2.2/integration/lifecycle/chaincode/caller/cmd",
					Ctor:    `{"Args":[""]}`,
					Policy:  ccEP,
				}
				calleeDefOld = nwo.Chaincode{
					Name:    "callee",
					Version: "0.0",
					Path:    "github.com/Yunpeng-J/HLF-2.2/integration/lifecycle/chaincode/callee/cmd",
					Ctor:    `{"Args":[""]}`,
					Policy:  ccEP,
				}
				callerDefNew = nwo.Chaincode{
					Name:            "caller",
					Version:         "0.0",
					Path:            components.Build("github.com/Yunpeng-J/HLF-2.2/integration/lifecycle/chaincode/caller/cmd"),
					Lang:            "binary",
				...
				calleeDefNew = nwo.Chaincode{
					Name:            "callee",
					Version:         "0.0",
					Path:            components.Build("github.com/Yunpeng-J/HLF-2.2/integration/lifecycle/chaincode/callee/cmd"),
					Lang:            "binary",
